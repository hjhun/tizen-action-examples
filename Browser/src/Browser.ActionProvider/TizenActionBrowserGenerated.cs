...
namespace RPCPort
{
    namespace TizenActionBrowserGenerated
    {
        ...
        public class TizenEntityBrowser: TizenEntity
        {
            ...
            public TizenEntityBrowser()
            {
            }

            public string ToJson()
            {
                string json_str = "{\"TizenEntityBrowser\":{";
                json_str += "\"Id\":";
                AppendToJson(ref json_str, Id);
        json_str += ",";        json_str += "\"Extra\":";
                AppendToJson(ref json_str, Extra);
        ...
        namespace Stub
        {
            public class TizenActionBrowser : StubBase
            {
                ...
                public abstract class ServiceBase
                {
                    ...
                    public abstract TizenEntityStatus GetCurrent(out TizenEntityBrowser result);

                    public abstract TizenEntityStatus Go(TizenEntityBrowser browser);

                    public abstract TizenEntityStatus ToCalendar(TizenEntityBrowser browser, out TizenEntityCalendar result);

                    public abstract TizenEntityStatus ToPresentation(TizenEntityBrowser browser, out TizenEntityPresentation result);

                    public abstract TizenEntityStatus GetBrowserByIds(List<string> ids, out List<TizenEntityBrowser> result, out List<string> unresolvedIds);
                ...
                internal class UnitMap
                {
                    ...
                    internal void Read(int name, out List<TizenEntityBrowser> value)
                    {
                        value = new List<TizenEntityBrowser>();
                        ...
                        Unit unit = map[name];
                        if (unit.type != -1914560483 /*array_TizenEntityBrowser*/)
                        {
                            Tizen.Log.Error("RPC_PORT", "type is not array_TizenEntityBrowser : " + unit.type);
                            return;
                        }
                        TizenActionBrowser.Deserialize(unit.parcel, value);
                    }

                    internal void Write(int name, List<TizenEntityBrowser> value)
                    {
                        Unit unit = new Unit();
                        unit.name = name;
                        unit.type = -1914560483; /*array_TizenEntityBrowser*/
                    ...
                    internal void Read(int name, out TizenEntityBrowser value)
                    {
                        value = new TizenEntityBrowser();
                        if (map.ContainsKey(name) == false)
                        {
                            Tizen.Log.Error("RPC_PORT", "Not exist key " + name);
                            return;
                        ...
                        Unit unit = map[name];
                        if (unit.type != -367491416 /*TizenEntity::TizenEntityBrowser*/)
                        {
                            Tizen.Log.Error("RPC_PORT", "type is not TizenEntity::TizenEntityBrowser : " + unit.type);
                            return;
                        }
                        TizenActionBrowser.Deserialize(unit.parcel, value);
                    }

                    internal void Write(int name, TizenEntityBrowser value)
                    {
                        Unit unit = new Unit();
                        unit.name = name;
                        unit.type = -367491416; /*TizenEntity::TizenEntityBrowser*/
                        unit.cmds.Add((parcel) =>
                        {
                            TizenActionBrowser.Serialize(parcel, value);
                        });
                ...
                private static void Serialize(Parcel h, TizenEntityBrowser param)
                {
                ...
                private static void Deserialize(Parcel h, TizenEntityBrowser param)
                {
                ...
                private static void Serialize(Parcel h, List<TizenEntityBrowser> param)
                {
                ...
                private static void Deserialize(Parcel h, List<TizenEntityBrowser> param)
                {
                    int l = h.ReadArrayCount();
                    for (int i = 0; i < l; i++)
                    {
                        var k = new TizenEntityBrowser();
                        Deserialize(h, k);
                        param.Add(k);
                    }
                }
                        ...
                        switch ((MethodId)cmd)
                        {
                            case MethodId.GetCurrent:
                            {
                                ...
                                if (b._is_app && CheckPrivilege((MethodId)cmd, b) == false)
                                {
                                    ...
                                    try
                                    {
                                        var retVal = b.GetCurrent(out TizenEntityBrowser param1);
                            ...
                            case MethodId.Go:
                            {
                                map.Read(150940456 /*browser*/, out TizenEntityBrowser param1);
                                UnitMap result_map = new UnitMap();
                                if (b._is_app && CheckPrivilege((MethodId)cmd, b) == false)
                                {
                                    RemoteException ex = new RemoteException("Permission denied", (int)Tizen.Internals.Errors.ErrorCode.PermissionDenied);
                            ...
                            case MethodId.ToCalendar:
                            {
                                ...
                                if (b._is_app && CheckPrivilege((MethodId)cmd, b) == false)
                                {
                                    ...
                                    try
                                    {
                                        var retVal = b.ToCalendar(param1, out TizenEntityCalendar param2);
                                        result_map.Write(1497479973 /*[RESULT]*/, retVal);
                            ...
                            case MethodId.GetBrowserByIds:
                            {
                                ...
                                if (b._is_app && CheckPrivilege((MethodId)cmd, b) == false)
                                {
                                    ...
                                    try
                                    {
                                        var retVal = b.GetBrowserByIds(param1, out List<TizenEntityBrowser> param2, out List<string> param3);
                                        result_map.Write(1497479973 /*[RESULT]*/, retVal);
                                        result_map.Write(-934426595 /*result*/, param2);
