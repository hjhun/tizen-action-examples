...
namespace RPCPort
{
    namespace PhotoGalleryActionProvider
    {
        ...
        public class TizenEntityFile: TizenEntity
        {
            ...
            public TizenEntityFile()
            {
            }

            public string ToJson()
            {
                string json_str = "{\"TizenEntityFile\":{";
                json_str += "\"Id\":";
                AppendToJson(ref json_str, Id);
        json_str += ",";        json_str += "\"Extra\":";
                AppendToJson(ref json_str, Extra);
        ...
        json_str += ",";        json_str += "\"StorageType\":";
                AppendToJson(ref json_str, StorageType);
        json_str += ",";        json_str += "\"Size\":";
                AppendToJson(ref json_str, Size);
        json_str += ",";        json_str += "\"ModifiedDate\":";
                AppendToJson(ref json_str, ModifiedDate);
        json_str += ",";        json_str += "\"MimeType\":";
                AppendToJson(ref json_str, MimeType);
                json_str += "}}";
                return json_str;
            }
        ...
        json_str += ",";        json_str += "\"File\":";
                AppendToJson(ref json_str, File);
        ...
        namespace Stub
        {
            public class TizenActionPhoto : StubBase
            {
                ...
                public abstract class ServiceBase
                {
                    ...
                    public abstract TizenEntityStatus AddPhoto(TizenEntityPhoto photo);

                    public abstract TizenEntityStatus DeletePhoto(TizenEntityPhoto photo);

                    public abstract TizenEntityStatus GetCurrent(out TizenEntityPhoto result);

                    public abstract TizenEntityStatus Search(TizenEntityQuery query, out List<TizenEntityPhoto> result);

                    public abstract TizenEntityStatus Show(TizenEntityPhoto photo);

                    public abstract TizenEntityStatus StartSlideshow();

                    public abstract TizenEntityStatus StopSlideshow();
                ...
                private static void Serialize(Parcel h, TizenEntityFile param)
                {
                    Serialize(h, (TizenEntity)param);
                    h.WriteString(param.Path);
                    h.WriteString(param.StorageType);
                    h.WriteInt(param.Size);
                    h.WriteString(param.ModifiedDate);
                    h.WriteString(param.MimeType);
                }

                private static void Deserialize(Parcel h, TizenEntityFile param)
                {
                    Deserialize(h, (TizenEntity)param);
                    var Path = h.ReadString();
                    param.Path = Path;
                    var StorageType = h.ReadString();
                    param.StorageType = StorageType;
                    var Size = h.ReadInt();
                    param.Size = Size;
                    var ModifiedDate = h.ReadString();
                    param.ModifiedDate = ModifiedDate;
                    var MimeType = h.ReadString();
                ...
                private static void Deserialize(Parcel h, TizenEntityPhoto param)
                {
                    ...
                    param.Date = Date;
                    param.File = new TizenEntityFile();
                    Deserialize(h, param.File);
                        ...
                        switch ((MethodId)cmd)
                        {
                            ...
                            case MethodId.DeletePhoto:
                            {
                                ...
                                if (b._is_app && CheckPrivilege((MethodId)cmd, b) == false)
                                {
                                    ...
                                    try
                                    {
                                        var retVal = b.DeletePhoto(param1);
                                        result_map.Write(1497479973 /*[RESULT]*/, retVal);
                                    } catch (RemoteException ex)
                                    {
                                        result_map.Write(-1571313492 /*[REMOTE_EXCEPTION]*/, ex);
                            ...
                            case MethodId.GetCurrent:
                            {
                                ...
                                if (b._is_app && CheckPrivilege((MethodId)cmd, b) == false)
                                {
                                    ...
                                    try
                                    {
                                        var retVal = b.GetCurrent(out TizenEntityPhoto param1);
                                        result_map.Write(1497479973 /*[RESULT]*/, retVal);
