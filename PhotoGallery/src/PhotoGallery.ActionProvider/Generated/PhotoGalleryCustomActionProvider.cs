...
namespace RPCPort
{
    namespace PhotoGalleryCustomActionProvider
    {
        ...
        namespace Stub
        {
            public class TizenActionPhotoGalleryCustom : StubBase
            {
                ...
                private static TizenActionPhotoGalleryCustom _instance;
                ...
                public abstract class ServiceBase
                {
                    ...
                    public abstract TizenEntityStatus SetFavorite(string id, bool favorite);
                ...
                internal class UnitMap
                {
                    ...
                    internal void Read(int name, out TizenEntityStatus value)
                    {
                        ...
                        TizenActionPhotoGalleryCustom.Deserialize(unit.parcel, value);
                    }
                    ...
                    internal void Write(int name, TizenEntityStatus value)
                    {
                        ...
                        {
                            TizenActionPhotoGalleryCustom.Serialize(parcel, value);
                        });
                ...
                internal void OnLemReceivedEvent(string instance, Parcel p)
                {
                    if (Thread.CurrentThread.ManagedThreadId != 1)
                    {
                        ...
                        {
                            ((TizenActionPhotoGalleryCustom)data).OnReceivedEvent(instance, null, p);
                        }, this);
                    }
                    else
                    {
                ...
                internal  bool OnReceivedEvent(string instance, Port port, Parcel p)
                {
                    try
                    {
                        ...
                        switch ((MethodId)cmd)
                        {
                            ...
                            case MethodId.SetFavorite:
                            {
                                map.Read(3355 /*id*/, out string param1);
                                map.Read(1050790300 /*favorite*/, out bool param2);
                                UnitMap result_map = new UnitMap();
                                if (b._is_app && CheckPrivilege((MethodId)cmd, b) == false)
                                {
                                    RemoteException ex = new RemoteException("Permission denied", (int)Tizen.Internals.Errors.ErrorCode.PermissionDenied);
                                    ...
                                    try
                                    {
                                        var retVal = b.SetFavorite(param1, param2);
                                        result_map.Write(1497479973 /*[RESULT]*/, retVal);
                                    } catch (RemoteException ex)
                                    {
                                        result_map.Write(-1571313492 /*[REMOTE_EXCEPTION]*/, ex);
                ...
                internal void OnLemDisconnectedEvent(string sender, string instance)
                {
                    if (Thread.CurrentThread.ManagedThreadId != 1)
                    {
                        _async_context.Post((data) =>
                        {
                            ((TizenActionPhotoGalleryCustom)data).OnDisconnectedEvent(sender, instance);
                        }, this);
                    }
                    else
                    {
                ...
                internal static TizenActionPhotoGalleryCustom GetInstance()
                {
                    return _instance;
                }
                ...
                public TizenActionPhotoGalleryCustom() : base("TizenActionPhotoGalleryCustom")
                {
                    _instance = this;
