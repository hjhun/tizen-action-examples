...
namespace RPCPort
{
    namespace DisplayActions
    {
        ...
        namespace Stub
        {
            public class TizenActionPresentation : StubBase
            {
                ...
                private static TizenActionPresentation _instance;
                ...
                internal class UnitMap
                {
                    ...
                    internal void Read(int name, out TizenEntityPresentation value)
                    {
                        ...
                        TizenActionPresentation.Deserialize(unit.parcel, value);
                    }
                    ...
                    internal void Write(int name, TizenEntityPresentation value)
                    {
                        ...
                        {
                            TizenActionPresentation.Serialize(parcel, value);
                        });
                ...
                internal void OnLemReceivedEvent(string instance, Parcel p)
                {
                    if (Thread.CurrentThread.ManagedThreadId != 1)
                    {
                        ...
                        {
                            ((TizenActionPresentation)data).OnReceivedEvent(instance, null, p);
                        }, this);
                    }
                    else
                    {
                ...
                internal void OnLemDisconnectedEvent(string sender, string instance)
                {
                    if (Thread.CurrentThread.ManagedThreadId != 1)
                    {
                        _async_context.Post((data) =>
                        {
                            ((TizenActionPresentation)data).OnDisconnectedEvent(sender, instance);
                        }, this);
                    }
                    else
                    {
                ...
                internal static TizenActionPresentation GetInstance()
                {
                    return _instance;
                }
                ...
                public TizenActionPresentation() : base("TizenActionPresentation")
                {
                    _instance = this;
