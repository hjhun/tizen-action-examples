...
namespace RPCPort
{
    namespace DisplayActions
    {
        ...
        namespace Stub
        {
            public class TizenActionDisplay : StubBase
            {
                ...
                private static TizenActionDisplay _instance;
                ...
                public abstract class ServiceBase
                {
                    ...
                    public abstract TizenEntityStatus Show(TizenEntityPresentation presentation);
                ...
                internal class UnitMap
                {
                    ...
                    internal void Read(int name, out TizenEntityPresentation value)
                    {
                        ...
                        TizenActionDisplay.Deserialize(unit.parcel, value);
                    }
                    ...
                    internal void Write(int name, TizenEntityPresentation value)
                    {
                        ...
                        {
                            TizenActionDisplay.Serialize(parcel, value);
                        });
                ...
                internal void OnLemReceivedEvent(string instance, Parcel p)
                {
                    if (Thread.CurrentThread.ManagedThreadId != 1)
                    {
                        ...
                        {
                            ((TizenActionDisplay)data).OnReceivedEvent(instance, null, p);
                        }, this);
                    }
                    else
                    {
                ...
                internal  bool OnReceivedEvent(string instance, Port port, Parcel p)
                {
                    try
                    {
                        ...
                        switch ((MethodId)cmd)
                        {
                            case MethodId.Show:
                            {
                                map.Read(696975130 /*presentation*/, out TizenEntityPresentation param1);
                ...
                internal void OnLemDisconnectedEvent(string sender, string instance)
                {
                    if (Thread.CurrentThread.ManagedThreadId != 1)
                    {
                        _async_context.Post((data) =>
                        {
                            ((TizenActionDisplay)data).OnDisconnectedEvent(sender, instance);
                        }, this);
                    }
                    else
                    {
                ...
                internal static TizenActionDisplay GetInstance()
                {
                    return _instance;
                }
                ...
                public TizenActionDisplay() : base("TizenActionDisplay")
                {
                    _instance = this;
