...
namespace RPCPort
{
    namespace ViewActions
    {
        ...
        namespace Stub
        {
            public class TizenInternalActionView : StubBase
            {
                ...
                private static TizenInternalActionView _instance;
                ...
                internal class UnitMap
                {
                    ...
                    internal void Read(int name, out List<TizenEntityView> value)
                    {
                        ...
                        TizenInternalActionView.Deserialize(unit.parcel, value);
                    }
                    ...
                    internal void Write(int name, List<TizenEntityView> value)
                    {
                        ...
                        {
                            TizenInternalActionView.Serialize(parcel, value);
                        });
                ...
                private bool CheckPrivilege(MethodId id, ServiceBase b)
                {
                    ...
                    foreach (var item in privileges)
                    {
                        ...
                        has = false;
#else
                        // Older released Tizen.NET packages do not expose the UDS-specific API.
                        // Deny rather than weakening the generated privilege check.
                        has = false;
#endif
                        if (has == false) {
                ...
                internal void OnLemReceivedEvent(string instance, Parcel p)
                {
                    if (Thread.CurrentThread.ManagedThreadId != 1)
                    {
                        ...
                        {
                            ((TizenInternalActionView)data).OnReceivedEvent(instance, null, p);
                        }, this);
                    }
                    else
                    {
                ...
                internal void OnLemDisconnectedEvent(string sender, string instance)
                {
                    if (Thread.CurrentThread.ManagedThreadId != 1)
                    {
                        _async_context.Post((data) =>
                        {
                            ((TizenInternalActionView)data).OnDisconnectedEvent(sender, instance);
                        }, this);
                    }
                    else
                    {
                ...
                internal static TizenInternalActionView GetInstance()
                {
                    return _instance;
                }
                ...
                public TizenInternalActionView() : base("TizenInternalActionView")
                {
                    _instance = this;
