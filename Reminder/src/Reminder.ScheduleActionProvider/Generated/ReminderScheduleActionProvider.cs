...
namespace RPCPort
{
    namespace ReminderScheduleActionProvider
    {
        ...
        namespace Stub
        {
            public class TizenActionReminder : StubBase
            {
                ...
                private static TizenActionReminder _instance;
                ...
                public abstract class ServiceBase
                {
                    ...
                    public abstract TizenEntityStatus Add(TizenEntityReminder reminder);

                    public abstract TizenEntityStatus Delete(TizenEntityReminder reminder);

                    public abstract TizenEntityStatus Search(TizenEntityQuery query, out List<TizenEntityReminder> result);

                    public abstract TizenEntityStatus ToPresentation(TizenEntityReminder reminder, out TizenEntityPresentation result);

                    public abstract TizenEntityStatus Update(TizenEntityReminder reminder);
                ...
                internal class UnitMap
                {
                    ...
                    internal void Read(int name, out TizenEntityQuery value)
                    {
                        ...
                        TizenActionReminder.Deserialize(unit.parcel, value);
                    }
                    ...
                    internal void Write(int name, TizenEntityQuery value)
                    {
                        ...
                        {
                            TizenActionReminder.Serialize(parcel, value);
                        });
                ...
                internal void OnLemReceivedEvent(string instance, Parcel p)
                {
                    if (Thread.CurrentThread.ManagedThreadId != 1)
                    {
                        ...
                        {
                            ((TizenActionReminder)data).OnReceivedEvent(instance, null, p);
                        }, this);
                    }
                    else
                    {
                        ...
                        switch ((MethodId)cmd)
                        {
                            ...
                            case MethodId.Search:
                            {
                                ...
                                if (b._is_app && CheckPrivilege((MethodId)cmd, b) == false)
                                {
                                    ...
                                    try
                                    {
                                        var retVal = b.Search(param1, out List<TizenEntityReminder> param2);
                                        result_map.Write(1497479973 /*[RESULT]*/, retVal);
                ...
                internal void OnLemDisconnectedEvent(string sender, string instance)
                {
                    if (Thread.CurrentThread.ManagedThreadId != 1)
                    {
                        _async_context.Post((data) =>
                        {
                            ((TizenActionReminder)data).OnDisconnectedEvent(sender, instance);
                        }, this);
                    }
                    else
                    {
                ...
                internal static TizenActionReminder GetInstance()
                {
                    return _instance;
                }
                ...
                public TizenActionReminder() : base("TizenActionReminder")
                {
                    _instance = this;
