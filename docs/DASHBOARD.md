...
- [ ] DisplayPresentation — `Tizen.Action.Display` infrastructure fixture
  ...
  - Protocol baseline: retain legacy v0.8 `surfaceUpdate`/`dataModelUpdate` compatibility without calling it v0.9.1; add canonical lifecycle/catalog versions only through explicit adapters and fixtures.
