        ...
        namespace Stub
        {
            public class TizenActionCalendar : StubBase
            {
                ...
                public abstract class ServiceBase
                {
                    ...
                    public abstract TizenEntityStatus AddEvent(TizenEntityCalendarEvent calendarEvent);

                    public abstract TizenEntityStatus DeleteEvent(TizenEntityCalendarEvent calendarEvent);

                    public abstract TizenEntityStatus Search(TizenEntityCalendarQuery calendarQuery, out List<TizenEntityCalendarEvent> result);

                    public abstract TizenEntityStatus ToPresentation(List<TizenEntityCalendarEvent> CalendarEvent, out TizenEntityPresentation result);

                    public abstract TizenEntityStatus UpdateEvent(TizenEntityCalendarEvent calendarEvent);
                ...
                internal class UnitMap
                {
                    ...
                    internal void Read(int name, out TizenEntityCalendarQuery value)
                    {
                        value = new TizenEntityCalendarQuery();
                        ...
                        Unit unit = map[name];
                        if (unit.type != 23214017 /*TizenEntity::TizenEntityQuery::TizenEntityCalendarQuery*/)
                        {
                            Tizen.Log.Error("RPC_PORT", "type is not TizenEntity::TizenEntityQuery::TizenEntityCalendarQuery : " + unit.type);
                            return;
                        }
                        TizenActionCalendar.Deserialize(unit.parcel, value);
                    }

                    internal void Write(int name, TizenEntityCalendarQuery value)
                    {
                        Unit unit = new Unit();
                        unit.name = name;
                        unit.type = 23214017; /*TizenEntity::TizenEntityQuery::TizenEntityCalendarQuery*/
                ...
                internal  bool OnReceivedEvent(string instance, Port port, Parcel p)
                {
                    try
                    {
                        ...
                        switch ((MethodId)cmd)
                        {
                            ...
                            {
                                map.Read(1939201532 /*calendarEvent*/, out TizenEntityCalendarEvent param1);
                            ...
                            case MethodId.DeleteEvent:
                            {
                                ...
                                if (b._is_app && CheckPrivilege((MethodId)cmd, b) == false)
                                {
                                    ...
                                    try
                                    {
                                        var retVal = b.DeleteEvent(param1);
                                        result_map.Write(1497479973 /*[RESULT]*/, retVal);
                                    } catch (RemoteException ex)
                                    {
                                        result_map.Write(-1571313492 /*[REMOTE_EXCEPTION]*/, ex);
                            ...
                            {
                                map.Read(1950254122 /*calendarQuery*/, out TizenEntityCalendarQuery param1);
                                UnitMap result_map = new UnitMap();
                                if (b._is_app && CheckPrivilege((MethodId)cmd, b) == false)
                                {
                                    RemoteException ex = new RemoteException("Permission denied", (int)Tizen.Internals.Errors.ErrorCode.PermissionDenied);
                                    ...
                                    try
                                    {
                                        var retVal = b.Search(param1, out List<TizenEntityCalendarEvent> param2);
                                        result_map.Write(1497479973 /*[RESULT]*/, retVal);
                            ...
                            {
                                map.Read(-1556804132 /*CalendarEvent*/, out List<TizenEntityCalendarEvent> param1);
                                UnitMap result_map = new UnitMap();
                                if (b._is_app && CheckPrivilege((MethodId)cmd, b) == false)
                                {
                                    RemoteException ex = new RemoteException("Permission denied", (int)Tizen.Internals.Errors.ErrorCode.PermissionDenied);
