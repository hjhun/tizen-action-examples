...
namespace RPCPort
{
    namespace CalendarActionProvider
    {
        ...
        public class TizenEntityCalendar: TizenEntity
        {
            ...
            public TizenEntityCalendar()
            {
            }

            public string ToJson()
            {
                string json_str = "{\"TizenEntityCalendar\":{";
                json_str += "\"Id\":";
                AppendToJson(ref json_str, Id);
        json_str += ",";        json_str += "\"Extra\":";
                AppendToJson(ref json_str, Extra);
        ...
        public class TizenEntityCalendarSearchQuery: TizenEntityQuery
        {
            ...
            public TizenEntityCalendarSearchQuery()
            {
            }

            public string ToJson()
            {
                string json_str = "{\"TizenEntityCalendarSearchQuery\":{";
                json_str += "\"Id\":";
                AppendToJson(ref json_str, Id);
        json_str += ",";        json_str += "\"Extra\":";
                AppendToJson(ref json_str, Extra);
        ...
        namespace Stub
        {
            public class TizenActionCalendar : StubBase
            {
                ...
                private static TizenActionCalendar _instance;
                ...
                public abstract class ServiceBase
                {
                    ...
                    public abstract TizenEntityStatus AddEvent(TizenEntityCalendar calendar);

                    public abstract TizenEntityStatus RemoveEvent(TizenEntityCalendar calendar);

                    public abstract TizenEntityStatus Search(TizenEntityQuery query, out List<TizenEntityCalendar> result);

                    public abstract TizenEntityStatus ToPresentation(TizenEntityCalendar calendar, out TizenEntityPresentation result);

                    public abstract TizenEntityStatus UpdateEvent(TizenEntityCalendar calendar);

                    public abstract TizenEntityStatus GetEventByIds(List<string> ids, out List<TizenEntityCalendar> result, out List<string> unresolvedIds);

                    public abstract TizenEntityStatus SearchInPeriod(TizenEntityCalendarSearchQuery calendarSearchQuery, out List<TizenEntityCalendar> result);
                ...
                internal class UnitMap
                {
                    ...
                    internal void Read(int name, out List<TizenEntityCalendar> value)
                    {
                        value = new List<TizenEntityCalendar>();
                        ...
                        Unit unit = map[name];
                        if (unit.type != 215655657 /*array_TizenEntityCalendar*/)
                        {
                            Tizen.Log.Error("RPC_PORT", "type is not array_TizenEntityCalendar : " + unit.type);
                            return;
                        }
                        TizenActionCalendar.Deserialize(unit.parcel, value);
                    }

                    internal void Write(int name, List<TizenEntityCalendar> value)
                    {
                        Unit unit = new Unit();
                        unit.name = name;
                        unit.type = 215655657; /*array_TizenEntityCalendar*/
                        unit.cmds.Add((parcel) =>
                        {
                            TizenActionCalendar.Serialize(parcel, value);
                        });
                    ...
                    internal void Read(int name, out TizenEntityCalendar value)
                    {
                        value = new TizenEntityCalendar();
                        if (map.ContainsKey(name) == false)
                        {
                            Tizen.Log.Error("RPC_PORT", "Not exist key " + name);
                            return;
                        ...
                        Unit unit = map[name];
                        if (unit.type != 930156478 /*TizenEntity::TizenEntityCalendar*/)
                        {
                            Tizen.Log.Error("RPC_PORT", "type is not TizenEntity::TizenEntityCalendar : " + unit.type);
                            return;
                        }
                        TizenActionCalendar.Deserialize(unit.parcel, value);
                    }

                    internal void Write(int name, TizenEntityCalendar value)
                    {
                        Unit unit = new Unit();
                        unit.name = name;
                        unit.type = 930156478; /*TizenEntity::TizenEntityCalendar*/
                        unit.cmds.Add((parcel) =>
                        {
                            TizenActionCalendar.Serialize(parcel, value);
                        });
                    ...
                    internal void Read(int name, out TizenEntityCalendarSearchQuery value)
                    {
                        value = new TizenEntityCalendarSearchQuery();
                        if (map.ContainsKey(name) == false)
                        {
                            Tizen.Log.Error("RPC_PORT", "Not exist key " + name);
                            return;
                        ...
                        Unit unit = map[name];
                        if (unit.type != 111889465 /*TizenEntity::TizenEntityQuery::TizenEntityCalendarSearchQuery*/)
                        {
                            Tizen.Log.Error("RPC_PORT", "type is not TizenEntity::TizenEntityQuery::TizenEntityCalendarSearchQuery : " + unit.type);
                            return;
                        }
                        TizenActionCalendar.Deserialize(unit.parcel, value);
                    }

                    internal void Write(int name, TizenEntityCalendarSearchQuery value)
                    {
                        Unit unit = new Unit();
                        unit.name = name;
                        unit.type = 111889465; /*TizenEntity::TizenEntityQuery::TizenEntityCalendarSearchQuery*/
                        unit.cmds.Add((parcel) =>
                        {
                            TizenActionCalendar.Serialize(parcel, value);
                        });
                ...
                private static void Serialize(Parcel h, TizenEntityCalendar param)
                {
                ...
                private static void Deserialize(Parcel h, TizenEntityCalendar param)
                {
                ...
                private static void Serialize(Parcel h, TizenEntityCalendarSearchQuery param)
                {
                ...
                private static void Deserialize(Parcel h, TizenEntityCalendarSearchQuery param)
                {
                ...
                private static void Serialize(Parcel h, List<TizenEntityCalendar> param)
                {
                ...
                private static void Deserialize(Parcel h, List<TizenEntityCalendar> param)
                {
                    int l = h.ReadArrayCount();
                    for (int i = 0; i < l; i++)
                    {
                        var k = new TizenEntityCalendar();
                        Deserialize(h, k);
                        param.Add(k);
                    }
                }
                ...
                internal void OnLemReceivedEvent(string instance, Parcel p)
                {
                    if (Thread.CurrentThread.ManagedThreadId != 1)
                    {
                        ...
                        {
                            ((TizenActionCalendar)data).OnReceivedEvent(instance, null, p);
                        }, this);
                    }
                    else
                    {
                ...
                internal  bool OnReceivedEvent(string instance, Port port, Parcel p)
                {
                    try
                    {
                        ...
                        switch ((MethodId)cmd)
                        {
                            case MethodId.AddEvent:
                            {
                                map.Read(-178324674 /*calendar*/, out TizenEntityCalendar param1);
                            ...
                            case MethodId.RemoveEvent:
                            {
                                ...
                                if (b._is_app && CheckPrivilege((MethodId)cmd, b) == false)
                                {
                                    ...
                                    try
                                    {
                                        var retVal = b.RemoveEvent(param1);
                                        result_map.Write(1497479973 /*[RESULT]*/, retVal);
                                    } catch (RemoteException ex)
                                    {
                                        result_map.Write(-1571313492 /*[REMOTE_EXCEPTION]*/, ex);
                            ...
                            case MethodId.Search:
                            {
                                ...
                                if (b._is_app && CheckPrivilege((MethodId)cmd, b) == false)
                                {
                                    ...
                                    try
                                    {
                                        var retVal = b.Search(param1, out List<TizenEntityCalendar> param2);
                                        result_map.Write(1497479973 /*[RESULT]*/, retVal);
                            ...
                            case MethodId.UpdateEvent:
                            {
                                ...
                                if (b._is_app && CheckPrivilege((MethodId)cmd, b) == false)
                                {
                                    ...
                                    try
                                    {
                                        var retVal = b.UpdateEvent(param1);
                                        result_map.Write(1497479973 /*[RESULT]*/, retVal);
                                    } catch (RemoteException ex)
                                    {
                                        result_map.Write(-1571313492 /*[REMOTE_EXCEPTION]*/, ex);
                            ...
                            case MethodId.GetEventByIds:
                            {
                                ...
                                if (b._is_app && CheckPrivilege((MethodId)cmd, b) == false)
                                {
                                    ...
                                    try
                                    {
                                        var retVal = b.GetEventByIds(param1, out List<TizenEntityCalendar> param2, out List<string> param3);
                                        result_map.Write(1497479973 /*[RESULT]*/, retVal);
                                        result_map.Write(-934426595 /*result*/, param2);
                            ...
                            {
                                map.Read(-259201566 /*calendarSearchQuery*/, out TizenEntityCalendarSearchQuery param1);
                                UnitMap result_map = new UnitMap();
                                if (b._is_app && CheckPrivilege((MethodId)cmd, b) == false)
                                {
                                    RemoteException ex = new RemoteException("Permission denied", (int)Tizen.Internals.Errors.ErrorCode.PermissionDenied);
                                    ...
                                    try
                                    {
                                        var retVal = b.SearchInPeriod(param1, out List<TizenEntityCalendar> param2);
                                        result_map.Write(1497479973 /*[RESULT]*/, retVal);
                                        result_map.Write(-934426595 /*result*/, param2);
                                    } catch (RemoteException ex)
                                    {
                ...
                internal void OnLemDisconnectedEvent(string sender, string instance)
                {
                    if (Thread.CurrentThread.ManagedThreadId != 1)
                    {
                        _async_context.Post((data) =>
                        {
                            ((TizenActionCalendar)data).OnDisconnectedEvent(sender, instance);
                        }, this);
                    }
                    else
                    {
                ...
                internal static TizenActionCalendar GetInstance()
                {
                    return _instance;
                }
                ...
                public TizenActionCalendar() : base("TizenActionCalendar")
                {
                    _instance = this;
